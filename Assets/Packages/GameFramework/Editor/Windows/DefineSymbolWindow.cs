...
namespace GameFramework
{
    internal class DefineSymbolWindow : SubWindow
    {
        ...
        {
            string activeDefineSymbols = PlayerSettings.GetScriptingDefineSymbols(NamedBuildTarget.FromBuildTargetGroup(targetGroup));
        ...
        private void SaveDefineSymbols()
        {
            ...
            PlayerSettings.SetScriptingDefineSymbols(NamedBuildTarget.FromBuildTargetGroup(targetGroup), sb.ToString());
        }
