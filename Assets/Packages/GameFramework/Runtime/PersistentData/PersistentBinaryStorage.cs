...
{
    internal class PersistentBinaryStorage : IPersistentStorage
    {
        ...
        private void ReadToData(byte[] bytes)
        {
            ...
            {
                bytes = CryptoUtility.DecryptBytesFromBytes(bytes, PersistentSetting.Instance.Password);
            }
        ...
        public T GetData<T>(string key, T defaultValue)
        {
            ...
            {
                defaultValue = BinaryUtility.ConvertToObject<T>(bytes);
            }
        ...
        public void SetData<T>(string key, T value)
        {
            ...
            data[key] = BinaryUtility.ConvertToBinary(value);
        }
