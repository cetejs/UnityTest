...
namespace Tests
{
    ...
    {
        public static bool IsIntersect(CustomCollider2D c1, CustomCollider2D c2)
        {
            BoxCustomCollider2D box1 = c1 as BoxCustomCollider2D;
            BoxCustomCollider2D box2 = c2 as BoxCustomCollider2D;
            CustomCircleCollider2D circle1 = c1 as CustomCircleCollider2D;
            CustomCircleCollider2D circle2 = c2 as CustomCircleCollider2D;
        ...
        public static bool BoxBoxAABBIntersect(BoxCustomCollider2D c1, BoxCustomCollider2D c2)
        {
        ...
        public static bool CircleCircleAABBIntersect(CustomCircleCollider2D c1, CustomCircleCollider2D c2)
        {
        ...
        public static bool BoxCircleAABBIntersectA(BoxCustomCollider2D c1, CustomCircleCollider2D c2)
        {
        ...
        public static bool BoxCircleAABBIntersectB(BoxCustomCollider2D c1, CustomCircleCollider2D c2)
        {
            Vector3 p1 = c1.transform.position + c1.bounds.Center;
            Vector3 p2 = c2.transform.position + c2.transform.rotation * c2.bounds.Center;
        ...
        public static bool BoxBoxOBBIntersect(BoxCustomCollider2D c1, BoxCustomCollider2D c2)
        {
        ...
        public static bool BoxCircleOBBIntersectA(BoxCustomCollider2D c1, CustomCircleCollider2D c2)
        {
            Vector3 p1 = c1.transform.position + c1.transform.rotation * c1.bounds.Center;
            Vector3 p2 = c2.transform.position + c2.transform.rotation * c2.bounds.Center;
        ...
        public static bool BoxCircleOBBIntersectB(BoxCustomCollider2D c1, CustomCircleCollider2D c2)
        {
            Vector3 p1 = c1.transform.position + c1.transform.rotation * c1.bounds.Center;
            Vector3 p2 = c2.transform.position + c2.transform.rotation * c2.bounds.Center;
            p2 = Quaternion.Inverse(c1.transform.rotation) * (p2 - p1) + p1;
        ...
        public static bool Raycast(Vector3 origin, Vector3 direction, float maxDistance, out HitInfo2D hit, CustomCollider2D col)
        {
            hit = new HitInfo2D();
            BoxCustomCollider2D boxCustom = col as BoxCustomCollider2D;
            CustomCircleCollider2D customCircle = col as CustomCircleCollider2D;
            if (boxCustom != null)
            {
                return RaycastBox(origin, direction, maxDistance, out hit, boxCustom);
            }

            if (customCircle != null)
            {
                return RaycastCircle(origin, direction, maxDistance, out hit, customCircle);
            }

            return false;
        }
        
        public static bool RaycastBox(Vector3 origin, Vector3 direction, float maxDistance, out HitInfo2D hit, BoxCustomCollider2D col)
        {
        ...
        public static bool RaycastCircle(Vector3 origin, Vector3 direction, float maxDistance, out HitInfo2D hit, CustomCircleCollider2D col)
        {
            hit = new HitInfo2D();
            Vector3 start = origin;
        ...
        public static int Linecast(Vector3 start, Vector3 end, HitInfo2D[] result, CustomCollider2D col)
        {
            BoxCustomCollider2D boxCustom = col as BoxCustomCollider2D;
            CustomCircleCollider2D customCircle = col as CustomCircleCollider2D;
            if (boxCustom != null)
            {
                return LinecastBox(start, end, result, boxCustom);
            }

            if (customCircle != null)
            {
                return LinecastCircle(start, end, result, customCircle);
            }

            return 0;
        }

        public static int LinecastBox(Vector3 start, Vector3 end, HitInfo2D[] result, BoxCustomCollider2D col)
        {
        ...
        public static int LinecastCircle(Vector3 start, Vector3 end, HitInfo2D[] result, CustomCircleCollider2D col)
        {
            if (result == null || result.Length == 0)
            {
                return 0;
